<template>
  <div class="_center2">
    <sub-title-bar
      title="湿度"
      icon="https://img.hzanchu.com/acimg/943c31e3e2eaad75c9a4cc91978ab098.png"
    ></sub-title-bar>
    <div class="_chart">
      <div id="center2-chart" class="_chart-chart"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  setup(props) {
    ...
    const initChart = (list) => {
      ...
      let chart = echarts.init(document.getElementById("center2-chart"));
        ...
        series: [
          {
            ...
            itemStyle: {
              color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
                { offset: 0, color: "#00BAFE" },
                { offset: 1, color: "rgba(51, 143, 249, 0.3)" },
              ]),
