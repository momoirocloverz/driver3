    ...
    <template v-if="!loading">
      ...
      >
        ...
        >
          ...
          <div class="_center">{{ item.blackNumber || item.redNumber }}次</div>
        </div>
      </div>

      <list-empty v-else customStyle="margin-top: 20px;height: 300px"></list-empty>
    </template>
