<template>
  <div class="_list">
    <div class="_top">
      ...
      <div class="_center">景点名称</div>
      <div class="_right">景点介绍</div>
    </div>
    ...
    >
      ...
      >
        ...
        <div class="_center">{{ item.attractions }}</div>
        <div class="_right">{{ item.introduction }}</div>
      </div>
    </div>
